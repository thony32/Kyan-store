                    ...
                    <ul>
                        {adminLinks.map((link) => (
                            <li key={link.href} className="mb-4">
                                <Link
                                    to={link.href}
                                    className="flex space-x-4 items-center px-8 py-2 hover:bg-blue-500 hover:text-white [&.active]:bg-blue-500 [&.active]:text-white rounded-md duration-200"
                                >
                                    {link.icon}
                                    <span>{link.name}</span>
                                </Link>
